...
import com.example.kotlin_social.android.common.components.CustomTextField
import com.example.kotlin_social.android.common.components.ScreenLevelLoadingErrorView
import com.example.kotlin_social.android.common.components.ScreenLevelLoadingView
import com.example.kotlin_social.android.common.theming.ButtonHeight
    ...
    Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        ...
        if (editProfileUiState.profile == null && editProfileUiState.errorMessage != null){
            ScreenLevelLoadingErrorView {
                onUiAction(EditProfileUiAction.FetchProfileAction(userId = userId.toLong()))
            }
        }
